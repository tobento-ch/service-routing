...
{    
    ...
    public function getRegex(array $parameters): null|string
    {
        ...
        // n{x}   :alphaNum:2   [2]      Matches any string that contains a sequence of X n's
        // n{x,y} :alphaNum:2:5 [2,5]    Matches any string that contains a sequence of X to Y n's
        // n{x,}  :alphaNum:2:  [2,null] Matches any string that contains a sequence of at least X n's
        
        $parameters = array_slice($parameters, 0, 2);
        
        return '[a-zA-Z0-9]{'.implode(',', $parameters).'}';
    }
